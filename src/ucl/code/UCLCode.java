...
public class UCLCode {
	...
	/**
	 * get security energy level ucl.code
	 * @param
	 * @return security energy level ucl.code
	 * @author heweiliang
	 * @since 2017-06-11
	 * modified by *** ****-**-** ***************
	 */
	...
	/**
	 * set security energy level ucl.code
	 * @param  security energy level ucl.code
	 * @return
	 * @author heweiliang
	 * @since 2017-06-11
	 * modified by *** ****-**-** ***************
	...
	public void showCode() {
		/*
			请何伟亮同学在此处添加code展示代码
		 */
		System.out.println("He Weiliang");
	}
}